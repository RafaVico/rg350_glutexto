...
{
	draw_without_flip();
	spRectangle(screen->w*MENU_WIDTH,screen->h/4,0,screen->w*2/3,(4+menu_count)*font->maxheight,BACKGROUND_MENU_COLOR);
	int pos = screen->h/4-(4+menu_count)*font->maxheight/2;
	spFontDrawMiddle(screen->w*MENU_WIDTH,0,0,menu_name,font);
