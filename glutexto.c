...
#define FONT_LOCATION "./font/pfcb.ttf"
#define FONT_SIZE 8
#define FONT_COLOR spGetRGB(255,255,255)
#define BACKGROUND_COLOR spGetRGB(196,77,41)
#define BACKGROUND_MENU_COLOR spGetRGB(216,97,61)
...
#define SELECTED_BACKGROUND_COLOR spGetRGB(255,242,117)
